...
# Define your symptoms dictionary and diseases list
...
data = pd.read_csv('training.csv')  # Replace 'dataset.csv' with the actual file name.
...
desc, pre, med, diet, wrkt = helper(predicted_disease)
...
print("********************Workout*******************************")
for i, w_i in enumerate(wrkt, 1):
    print(f"{i}: {w_i}")

print("***********************Diet********************************")
for i, d_i in enumerate(diet, 1):
    print(f"{i}: {d_i}")
